...
각 해설 버튼은 독립적으로 동작하며, 누르면 짧은 로딩 뒤 해설이 펼쳐집니다.
...
사이드바 학습 옵션에서 아래 기능을 켜고 끌 수 있습니다.

- `미풀이 문제 우선 보기`
- `진행상황 보기`

`미풀이 문제 우선 보기`를 켜면 아직 한 번도 풀지 않은 문제가 남아 있을 때 해당 문제를 먼저 보여줍니다.  
`진행상황 보기`를 켜면 현재 선택한 과목 기준으로 진행률 카드와 퍼센트 바를 함께 볼 수 있습니다.
