...
- `미풀이 문제 우선 보기` 토글
  - 사이드바 학습 옵션에서 켜고 끌 수 있습니다.
  - 활성화하면 아직 한 번도 풀지 않은 문제가 남아 있을 때 해당 문제를 먼저 보여줍니다.
  - 이 모드에서는 `전체 문제` 필터만 사용할 수 있습니다.
- `진행상황 보기` 토글
  - 사이드바 학습 옵션에서 켜고 끌 수 있습니다.
  - 현재 선택한 과목 기준으로 진행률 퍼센트 바를 표시합니다.
  - 진행률은 `한 번 이상 풀이한 문제 수 / 전체 문제 수` 기준으로 실시간 반영됩니다.
