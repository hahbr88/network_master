      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        ...
        <section className="rounded-[1.75rem] border border-white/70 bg-white/72 p-3 shadow-[0_20px_80px_-28px_rgba(15,23,42,0.35)] backdrop-blur">
          <div className="grid gap-2 md:grid-cols-2">
            <ViewToggleButton
              active={view === 'quiz'}
              description={'\uBB38\uC81C\uB97C \uD480\uACE0 \uC815\uB2F5\uACFC \uC624\uB2F5 \uAE30\uB85D\uC744 \uBC14\uB85C \uD655\uC778\uD569\uB2C8\uB2E4.'}
              icon={<FiFileText />}
            ...
            <ViewToggleButton
              active={view === 'notes'}
              description={'\uC120\uD0DD\uC9C0 \uBA54\uBAA8\uC640 \uC624\uB2F5 \uB178\uD2B8\uB97C \uBAA8\uC544\uC11C \uBCF5\uC2B5\uD569\uB2C8\uB2E4.'}
              icon={<FiBookOpen />}
          ...
          >
              ...
              {view === 'quiz' ? (
                  ...
                  <div className="mt-6 grid gap-4">
                    <div className="rounded-[1.4rem] border border-slate-200 bg-slate-50 p-4">
                      <div>
                        ...
                        <p className="mt-2 text-sm leading-7 text-slate-600">
                          문제를 고르는 방식과 진행률 표시 여부를 여기에서 조절할 수 있습니다.
                        </p>
                      </div>
                        ...
                        >
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-1 text-xs leading-6 text-slate-500">
                              아직 풀지 않은 문제가 있으면 먼저 보여줍니다. 켜면 필터는 전체 문제로 고정됩니다.
                            </p>
                          </div>
                          <span
                      ...
                      <div className="rounded-[1.4rem] border border-slate-200 bg-slate-50 p-4">
                        <div className="flex items-end justify-between gap-3">
                          <div>
                            ...
                            <p className="mt-2 text-sm leading-7 text-slate-600">
                              현재 과목에서 얼마나 풀었는지 한눈에 확인할 수 있습니다.
                            </p>
                          </div>
                        ...
                        <div className="mt-4 grid gap-2 text-sm text-slate-600">
                          <p>
                            푼 문제 {solvedQuestionCount} / {subjectQuestions.length}
                          </p>
                    ...
                    <div className="rounded-[1.4rem] border border-slate-200 bg-slate-50 p-4">
                      <div>
                        ...
                        <p className="mt-2 text-sm leading-7 text-slate-600">
                          전체 문제, 오답 문제, 메모가 있는 문제만 골라서 볼 수 있습니다.
                        </p>
                      </div>
                      ...
                      {filterLockByUnsolved ? (
                        <p className="mt-3 text-xs leading-6 text-slate-500">
                          미풀이 문제 우선이 켜져 있으면 필터는 전체 문제만 사용할 수 있습니다.
                        </p>
                      ) : null}
                    </div>
                  </div>
                ...
                <div className="mt-6 rounded-[1.4rem] border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm leading-7 text-slate-600">
                    현재 과목에서 저장한 메모 개수를 확인하고 메모 복습 화면으로 이동할 수 있습니다.
                  </p>
        ...
        <footer className="rounded-[1.75rem] border border-slate-200/70 bg-white/82 px-6 py-5 text-slate-900 shadow-[0_20px_60px_-36px_rgba(15,23,42,0.4)] backdrop-blur md:px-7">
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-sm leading-7 text-slate-600">
                {'\uB124\uD2B8\uC6CC\uD06C \uB9C8\uC2A4\uD130 \uAE30\uCD9C \uBB38\uC81C\uC640 \uBCF5\uC2B5 \uAE30\uB85D\uC744 \uD55C \uACF3\uC5D0\uC11C \uAD00\uB9AC\uD560 \uC218 \uC788\uB3C4\uB85D \uB9CC\uB4E0 \uD559\uC2B5 \uB3C4\uAD6C\uC785\uB2C8\uB2E4.'}
              </p>
              <div className="mt-4 grid gap-2 text-sm text-slate-600">
                <p>{'\uC81C\uC791: hahbr'}</p>
                <p>Version 0.1.0</p>
            ...
            <div>
              ...
              <div className="mt-3 grid gap-3 text-sm text-slate-600">
                <p>이 서비스는 개인 학습용으로 만든 비공식 문제 풀이 도구입니다.</p>
                ...
                에서 확인해 주세요. 앱 내 기록은 브라우저 로컬 스토리지에 저장됩니다.
                </p>
              </div>
            </div>
          </div>
        ...
        <ConfirmModal
          ...
          description={'\uD604\uC7AC \uD480\uC774 \uC0C1\uD0DC\uB294 \uC720\uC9C0\uB429\uB2C8\uB2E4. Enter \uD0A4\uB85C\uB3C4 \uB2E4\uC74C \uBB38\uC81C\uB85C \uC774\uB3D9\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.'}
          confirmLabel={'\uC774\uB3D9'}
          cancelLabel={'\uCDE8\uC18C'}
